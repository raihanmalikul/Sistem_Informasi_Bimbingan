    					...
    					<div class="card-body">
    						...
    						<div class="form-group">
    							<input class="form-control form-control-lg" type="text" name="npm_mhs_1"
    								value="<?= set_value('npm_mhs_1') ?>" placeholder="NPM Mahasiswa 1"
    								autocomplete="off">
    							<?= form_error('npm_mhs_1', '<small class="text-danger pl-3">', '</small>'); ?>
    						</div>
    						<div class="form-group">
    							<select class="form-control" value="<?= set_value('name_mhs_1') ?>" id="kelas"
    								name="kelas">
    						...
    						<div class="form-group">
    							<input class="form-control form-control-lg" type="text" name="npm_mhs_2"
    								value="<?= set_value('npm_mhs_2') ?>" placeholder="NPM Mahasiswa 2"
    								autocomplete="off">
    						...
    						<hr>
    						<div class="form-group">
    							<input class="form-control form-control-lg" type="text" readonly name="katagori_proyek"
    								value="Proyek 2" placeholder="katagori proyek" autocomplete="off">
    						...
    						<div class="form-group row">
    							<div class="col-sm-6 mb-3 mb-sm-0">
    								<input type="text" class="form-control form-control-user" id="exampleInputId_User"
